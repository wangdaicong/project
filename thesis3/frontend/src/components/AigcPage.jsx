...
import { Upload, FileText, Loader2, Download, Copy, Check, Sparkles, Shield, Zap, Clock } from 'lucide-react';
...
function AigcPage() {
  ...
  const handleProcess = async () => {
    ...
    try {
      const response = await fetch('/api/aigc/reduce', {
        method: 'POST',
