...
ALTER TABLE employment_data
    ...
    MODIFY COLUMN avg_salary INT DEFAULT NULL COMMENT '平均薪资',
...
ALTER TABLE user
    MODIFY COLUMN id BIGINT NOT NULL AUTO_INCREMENT COMMENT '主键ID',
    MODIFY COLUMN openid VARCHAR(100) DEFAULT NULL COMMENT '微信OpenID',
    MODIFY COLUMN nickname VARCHAR(50) DEFAULT NULL COMMENT '昵称',
    MODIFY COLUMN avatar VARCHAR(200) DEFAULT NULL COMMENT '头像URL',
    MODIFY COLUMN phone VARCHAR(20) DEFAULT NULL COMMENT '手机号',
    MODIFY COLUMN province VARCHAR(50) DEFAULT NULL COMMENT '省份',
    MODIFY COLUMN city VARCHAR(50) DEFAULT NULL COMMENT '城市',
    MODIFY COLUMN score INT DEFAULT NULL COMMENT '高考分数',
    MODIFY COLUMN subject_type VARCHAR(10) DEFAULT NULL COMMENT '科目类型',
    MODIFY COLUMN created_time DATETIME DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
    MODIFY COLUMN updated_time DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间';
...
ALTER TABLE admission_record
    ...
    MODIFY COLUMN province VARCHAR(50) NOT NULL COMMENT '省份',
    MODIFY COLUMN batch VARCHAR(20) DEFAULT NULL COMMENT '批次',
    MODIFY COLUMN student_name VARCHAR(50) DEFAULT NULL COMMENT '学生姓名',
    MODIFY COLUMN score INT DEFAULT NULL COMMENT '分数',
    MODIFY COLUMN rank_num INT DEFAULT NULL COMMENT '位次',
    MODIFY COLUMN created_time DATETIME DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间';

-- ========================================
-- 修复 assessment_record 表
-- ========================================
...
ALTER TABLE assessment_record
    MODIFY COLUMN id BIGINT NOT NULL AUTO_INCREMENT COMMENT '主键ID',
    MODIFY COLUMN user_id BIGINT NOT NULL COMMENT '用户ID',
    MODIFY COLUMN assessment_type VARCHAR(50) DEFAULT NULL COMMENT '测评类型',
    MODIFY COLUMN result TEXT COMMENT '测评结果',
    MODIFY COLUMN recommended_majors TEXT COMMENT '推荐专业',
    MODIFY COLUMN created_time DATETIME DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间';

-- ========================================
-- 修复 university_major 表
-- ========================================
...
ALTER TABLE university_major
    ...
    MODIFY COLUMN tuition DECIMAL(10,2) DEFAULT NULL COMMENT '学费',
    MODIFY COLUMN created_time DATETIME DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
    MODIFY COLUMN updated_time DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间';
...
SELECT '所有表和字段的注释已更新为中文' as result;
